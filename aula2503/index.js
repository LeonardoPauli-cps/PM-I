...
function operation() 
{
 ...
 function checkAccount(accountName)
 {
     if(!fs.existsSync(`accounts/${accountName}.json`))
     {
          console.error(chalk.bgRed.black(`A conta ${accountName} não existe! Veja se preencheu os dados corretamente.`))
          return false
     }
     return true
 }
 ...
 function addAmount(accountName, amount)
 {
    ...
    console.info(chalk.bgGreen.white(`O valor: ${amount}, foi depositado com sucesso.`))
 }
